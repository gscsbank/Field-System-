    ...
    function renderTable(logs) {
        ...
        logs.forEach(log => {
            ...
            tr.innerHTML = `
                ...
                <td class="px-5 py-3 border-b border-slate-100 font-normal text-slate-800 whitespace-nowrap">${log.officerName}</td>
                ...
                <td class="px-5 py-3 border-b border-slate-100 text-right font-normal text-orange-600 whitespace-nowrap">${log.totalDistance.toFixed(1)} KM</td>
            ...
            <div style="width: 210mm; min-height: 297mm; margin: auto; padding: 40px 50px; font-family: 'Arial', 'Helvetica', sans-serif; color: #000; background: #fff; box-sizing: border-box;">
                ...
                <div style="display:flex; align-items:flex-end; justify-content:space-between; border-bottom:1px solid #000; padding-bottom:12px; margin-bottom:24px;">
                    ...
                    <div style="text-align:right;">
                        <div style="font-size:11px; font-weight:600; letter-spacing:1px; text-transform:uppercase; color:#000;">MONTHLY TRANSPORT &amp; FUEL REPORT</div>
