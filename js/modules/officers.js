    ...
    async function renderManageOfficersList() {
        ...
        if (officersListUl) {
            ...
            officers.forEach((name, index) => {
                ...
                li.innerHTML = `
                    <span class="font-normal text-slate-700">${name}</span>
    ...
    function renderTable(logs) {
        ...
        logs.forEach(log => {
            ...
            tr.innerHTML = `
                ...
                <td class="px-5 py-3 border-b border-slate-100 font-normal text-slate-800">
                    <div class="flex items-center">
                        <div class="h-8 w-8 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center font-normal text-xs mr-3">
                            ${log.name.charAt(0).toUpperCase()}
                        </div>
                        ${log.name}
                    </div>
                </td>
                <td class="px-5 py-3 border-b border-slate-100 text-center font-normal text-emerald-600">${log.newAccounts}</td>
            ...
            <div style="width: 210mm; min-height: 297mm; margin: auto; padding: 40px 50px; font-family: 'Arial', 'Helvetica', sans-serif; color: #000; background: #fff; box-sizing: border-box;">
                ...
                <div style="display:flex; align-items:flex-end; justify-content:space-between; border-bottom:1px solid #000; padding-bottom:12px; margin-bottom:24px;">
                    ...
                    <div style="text-align:right;">
                        <div style="font-size:11px; font-weight:600; letter-spacing:1px; text-transform:uppercase; color:#000;">Daily Account Acquisition Report</div>
