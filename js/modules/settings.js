        ...
        authForm.addEventListener('submit', async (e) => {
            ...
            try {
                if (typeof window.changeAdminPassword === 'function') {
                    ...
                    authMsg.className = 'text-xs font-normal text-center text-emerald-600 mt-2 block animate__animated animate__fadeIn';
                ...
                authMsg.className = 'text-xs font-normal text-center text-red-500 mt-2 block animate__animated animate__shakeX';
                authMsg.classList.remove('hidden');
            }
        });
    }
